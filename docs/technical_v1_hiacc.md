...
- `2026-05-26`: results doc + HF model card drafted; Modal secret `huggingface` created from `.env`; pushing checkpoint-350 to `moorlee/qwen3-asr-0.6b-hinglish-hiacc-v1` (public).
